...
#include "genesis/test/fvmTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    //Test genesis
    case Network::fvmTestNetwork: return c_genesisInfoFvmTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::fvmMainNetwork: return c_genesisStateRootFvmMainNetwork;
    case Network::fvmTestNetwork: return c_genesisStateRootFvmTestNetwork;
