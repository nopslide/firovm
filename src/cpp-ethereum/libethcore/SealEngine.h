...
public:
    ...
    void setFvmSchedule(EVMSchedule _fvmSchedule) const { fvmSchedule = _fvmSchedule; }

    EVMSchedule& getFvmSchedule() const { return fvmSchedule; }
...
private:
    ...
    mutable EVMSchedule fvmSchedule; 
