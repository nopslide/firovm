...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The firovm address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)fvmDGP.getBlockSize(::ChainActive().Height()));
    obj.pushKV("mingasprice", (uint64_t)fvmDGP.getMinGasPrice(::ChainActive().Height()));
    obj.pushKV("blockgaslimit", (uint64_t)fvmDGP.getBlockGasLimit(::ChainActive().Height()));
        ...
        RPCHelpMan{"getaddressdeltas",
            "\nReturns all changes for an address (requires addressindex to be enabled).\n",
            {
                {"Input params", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                    {
                        {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The firovm addresses",
                            {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The firovm address"},
                            }
                        },
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    ...
    for (std::vector<std::pair<CAddressIndexKey, CAmount> >::const_iterator it=addressIndex.begin(); it!=addressIndex.end(); it++) {
        ...
        if (it->first.txindex == 1 && ((nHeight - it->first.blockHeight) < COINBASE_MATURITY))
...
{
            RPCHelpMan{"listconf",
                "\nReturns the current options that fvmd was started with.\n",
                {},
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue createmultisig(const JSONRPCRequest& request)
{
            RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of keys which are firovm addresses or hex-encoded public keys.",
                        {
                            {"key", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "firvm address or hex-encoded public key"},
                        }},
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The firovm address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\", \"signature\", \"my message\"")
                },
            }.Check(request);
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "fvm-cli and the GUI. There is no server-side difference.",
                {},
