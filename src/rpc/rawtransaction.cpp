...
{
    // Call into TxToUniv() in fvm-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in fvm-common, so we query them here and push the
...
static UniValue createrawtransaction(const JSONRPCRequest& request)
{
                            ...
                            {"contract", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "(send to contract)",
                                {
                                    ...
                                    {"amount", RPCArg::Type::AMOUNT,  /* default */ "0", "Value in FVM to send with the call, should be a valid amount, default 0"},
            ...
            + HelpExampleCli("createrawtransaction", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" \"[{\\\"contract\\\":{\\\"bytecode\\\":\\\"contractbytecode\\\","
                                                     "\\\"gasLimit\\\":2500000, \\\"gasPrice\\\":0.00000040, \\\"senderaddress\\\":\\\"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\\\"}}]\"")
...
UniValue decodepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed FiroVM transaction.\n",
                {
                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," FiroVM address if there is one"},
                                    }},
                                }},
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed FiroVM transactions into one transaction.\n"
