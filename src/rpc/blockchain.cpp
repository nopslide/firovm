...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); 
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); 
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if firovmd is started with -deprecatedrpc=size\n"
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of firovm addresses",
                                    {{RPCResult::Type::STR, "address", "firovm address"}}},
                            }},
...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxsupply",             pindexBestHeader->nMaxSupply / COIN);
...
static UniValue frc20name(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20name",
                ...
                RPCExamples{
                    HelpExampleCli("frc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("frc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue frc20symbol(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20symbol",
                ...
                RPCExamples{
                    HelpExampleCli("frc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("frc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue frc20totalsupply(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20totalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("frc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("frc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue frc20decimals(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20decimals",
                ...
                RPCExamples{
                    HelpExampleCli("frc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("frc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue frc20balanceof(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20balanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The firovm address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("frc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\"")
            + HelpExampleRpc("frc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\"")
                },
            }.Check(request);
...
static UniValue frc20allowance(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20allowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressFrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The firovm address of the account owning tokens"},
                    {"addressTo", RPCArg::Type::STR, RPCArg::Optional::NO,  "The firovm address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("frc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\" \"a1HwTdCmQV3NspP2QqCGpehoFpi8NY4Zg3\"")
            + HelpExampleRpc("frc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\" \"a1HwTdCmQV3NspP2QqCGpehoFpi8NY4Zg3\"")
                },
            }.Check(request);
...
static UniValue frc20listtransactions(const JSONRPCRequest& request)
{
            RPCHelpMan{"frc20listtransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"addresss", RPCArg::Type::STR, RPCArg::Optional::NO,  "The firovm address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver firovm address"},
                            {RPCResult::Type::STR, "sender", "The sender firovm address"},
                ...
                RPCExamples{
                    HelpExampleCli("frc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\"")
            + HelpExampleCli("frc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\" 0 6")
            + HelpExampleRpc("frc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\"")
            + HelpExampleRpc("frc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"a1kCCGddf5pMXSipLVD9hBG2MGGVNaJ15U\" 0 6")
                },
            }.Check(request);
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "frc20name",              &frc20name,              {"address"} },
    { "blockchain",         "frc20symbol",            &frc20symbol,            {"address"} },
    { "blockchain",         "frc20totalsupply",       &frc20totalsupply,       {"address"} },
    { "blockchain",         "frc20decimals",          &frc20decimals,          {"address"} },
    { "blockchain",         "frc20balanceof",         &frc20balanceof,         {"contractaddress", "address"} },
    { "blockchain",         "frc20allowance",         &frc20allowance,         {"contractaddress", "addressFrom", "addressTo"} },
    { "blockchain",         "frc20listtransactions",  &frc20listtransactions,  {"contractaddress", "address", "startblock", "minconf"} },
