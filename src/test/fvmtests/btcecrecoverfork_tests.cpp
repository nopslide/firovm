...
//    initState();
    ...
    std::vector<FvmTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createFvmTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFvmTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFvmTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFvmTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
