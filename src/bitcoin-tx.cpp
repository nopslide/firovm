...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " firovm-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  firovm-tx [options] <hex-tx> [commands]  Update hex-encoded firovm transaction\n" +
            "or:     firovm-tx [options] -create [commands]   Create hex-encoded firovm transaction\n" +
            "\n";
